...
import SignalingClientInstance from "./signalingClient.js";

// const DATA_STREAM_WS_URL = "ws://192.168.0.37:6001";
const iceServers = [{ urls: "stun:stun.l.google.com:19302" }];

let localStream: MediaStream;
let remoteStream: MediaStream;
let peerConnection: RTCPeerConnection;
const videoChatClient = new VideoChatRoom(SignalingClientInstance);

const localVideo: HTMLVideoElement = document.getElementById(
  "localVideo"
) as HTMLVideoElement;
...
//   dataStreamSocket.send(
//     JSON.stringify({ data: frameData, type: "frame", target: "teste" })
//   );
// }
